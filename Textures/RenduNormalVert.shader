...
Properties {
	...
	_effetpapier ("effetpapier", 2D) = "white" {}
	 ...
	 _effetpapierQuantite2 ("_effetpapierQuantite2", Float) = 1
}
SubShader {
...
void surf (Input IN, inout SurfaceOutput o) {
	 IN.worldPos*=_TailleTextures;
      ...
      float3 albedopapier;
        ...
        //albedopapier/=2/_effetpapierQuantite2;

	fixed4 c = IN.vertColor * _Color*albedopapier.r+ _Color2;
	o.Albedo = c.rgb;
	o.Alpha = c.a;
}
